  ...
  <div class="container">
    <div class="row align-items-center mb-5">
      ...
      <div class="col-lg-4">
        <div class="row">
          ...
          <div class="col-6">
            <a href="#" class="btn btn-block btn-primary btn-md">Daftar Sekarang</a>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-8">
        ...
        <div class="mb-5">
          <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-rocket mr-3"></span>Tanggung Jawab</h3>
          {!! $responsibilities !!}
        </div>
        @endif
        ...
        <div class="mb-5">
          <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-book mr-3"></span>Pengalaman + Pendidikan</h3>
          {!! $experience !!}
        </div>
        @endif
