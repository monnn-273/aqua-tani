      ...
      <div class="col-lg-8">
        <div class="card">
          <div class="card-header">
            <strong class="card-title">Informasi Mitra</strong>
          </div>
          <div class="card-body">
            <div id="pay-invoice">
              <div class="card-body">
                ...
                <form action="{{route('a.update-partner', ['id'=> $partner->id])}}" method="POST">
                  ...
                  <div class="form-group">
                    <label for="name" class="control-label mb-1">Nama Mitra</label>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <select name="role" id="role" class="form-control @error('role') is-invalid @enderror">
                        ...
                        <option value="2" @if($partner->role === 2) selected @endif>Mitra</option>
                        <option value="3" @if($partner->role === 3) selected @endif>Pengguna (Pelamar)</option>
                      </select>
                      @error('role')
                      <div class="text-danger text-sm">{{$message}}</div>
                      @enderror
